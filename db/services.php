...
$functions = array(
    'mod_congrea_quiz_list' => array(
        ...
        'type'        => 'read',
        'capabilities' => 'mod/congrea:managequiz',
    ...
    'mod_congrea_poll_save' => array(
        ...
        'type'        => 'write',
        'capabilities' => 'mod/congrea:managepoll',
        'services'     => array('Moodle Congrea Service')
    ),
    'mod_congrea_poll_data_retrieve' => array(
        ...
        'classpath'   => 'mod/congrea/externallib.php',
        'description' => 'Retrieve poll data saved in moodle database',
        'type'        => 'read',
        'capabilities' => 'mod/congrea:managepoll',
        'services'     => array('Moodle Congrea Service')
    ),
...
$services = array(
    'Congrea service' => array(
        'functions' => array(
            ...
            'mod_congrea_quiz_list',
            'mod_congrea_add_quiz',
            'mod_congrea_quiz_result',
            'mod_congrea_get_quizdata',
            'mod_congrea_poll_data_retrieve',
            'mod_congrea_poll_save',
            'mod_congrea_poll_delete',
            'mod_congrea_poll_option_drop',
            'mod_congrea_poll_result',
            'mod_congrea_poll_update'
        ),
        'restrictedusers' => 0,
        'enabled' => 1,
    )
