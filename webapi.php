...
define('FUNCTIONS_LIST', serialize(array('mod_congrea_poll_save', 'mod_congrea_poll_data_retrieve',
      'mod_congrea_poll_delete', 'mod_congrea_poll_update', 'mod_congrea_poll_result',
      'mod_congrea_poll_option_drop', 'core_course_get_enrolled_users_by_cmid',
...
// PARAMETERS.
switch ($functionname) {
    case 'core_course_get_enrolled_users_by_cmid': // Supported in Moodle 3.8 onwards only.
        $params = (int)$cmid;
